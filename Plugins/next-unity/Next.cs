...
namespace NetworkNext {
    ...
    */
    public static class Next
    {
        ...
        * </example>
        * <example>
        *   This is how you pass in an empty context and <see cref="NextConfig"/> to <see cref="NextInit"/>.
        * <code>
        *   // Get the default configuration
        *   Next.NextConfig config;
        *   Next.NextDefaultConfig(out config);
        ...
        *   <remarks>
        *       <para>
        *           The default log level is info. This includes
        *           both info messages and errors, which are both infrequent.
        *       </para>
        *   </remarks>
        * </summary>
        * <param name="level">the log level. Only logs <= the current log level are printed</param>
        ...
        *   <remarks>
        *       <para>
        *           This is the equivalent of <code>String.Format("{0:x}", userID)</code>
        ...
        * <returns><see cref="NEXT_OK"/> if the address was parsed successfully, <see cref="NEXT_ERROR"/> otherwise.</returns>
        * <example>
        * <code>
        ...
        * <param name="capacity">the buffer size to store the string representation of the address. Must be at least <see cref="NEXT_MAX_ADDRESS_STRING_LENGTH"/></param>
        ...
        * <param name="packetBytes"> the size of the packet in bytes. Must be in range 1 to <see cref="NEXT_MTU"/></param>
        * <example>
        * <code>
        *   void Update()
        *   {
        ...
        *   This is a struct that holds client statistics for a session on the server.
        *   <remarks>
        ...
        * <param name="packetBytes">the size of the packet. Must be in the range 1 to <see cref="NEXT_MTU"/></param>
        * <example>
        * <code>
        *   [MonoPInvokeCallback(typeof(NextServerPacketReceivedCallback))]
        *   static void ServerPacketReceived(IntPtr serverPtr, IntPtr ctxPtr, IntPtr NextAddress fromPtr, IntPtr packetDataPtr, int packetBytes)
